    ...
    public partial class initial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentalHealthResources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourcesAccessed = table.Column<int>(type: "integer", nullable: false),
                    MoodScoreAverage = table.Column<int>(type: "integer", nullable: false),
                    AnxietyScoreAverage = table.Column<int>(type: "integer", nullable: false),
                    WellbeingScoreAverage = table.Column<int>(type: "integer", nullable: false),
                    TherapistNotes = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportGroupId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Feedback_AspNetUsers_TherapistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "text", nullable: false),
                    PsychiatristId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportGroups_AspNetUsers_ModeratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportGroups_ModeratorId",
                table: "SupportGroups",
                column: "ModeratorId");
